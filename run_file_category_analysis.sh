...
python3 -m src.extract_agent_file_categories --data-dir ./data/nature_of_agent_conflicts_paper --output agent_filetype_chunks.csv
...
python3 -m src.generate_file_category_table agent_filetype_chunks.csv
